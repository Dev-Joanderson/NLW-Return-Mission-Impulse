            ...
            <div className="flex py-8 gap-2 w-full">
                {Object.entries(feedbackType).map(([key, value]) =>{
                    return(
                        <button 
                        key={key}
                        className="bg-zinc-800 rounded-lg py-5 flex-1 flex flex-col items-center gap-2 border-2 border-transparent hover:border-brand-500 focus:border-brand-500 focus:outline-none"
                        type="button">
